...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `recap`.`BULK_CUSTOMER_CODE_T`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `recap`.`BULK_REQUEST_ITEM_T`;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `recap`.`BULK_REQUEST_T`;
...
-- -----------------------------------------------------
-- Table `DEACCESSION_ITEM_CHANGE_LOG_T`
-- -----------------------------------------------------
